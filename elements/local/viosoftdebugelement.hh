#ifndef CLICK_VIOSOFTDEBUGELEMENT_HH
#define CLICK_VIOSOFTDEBUGELEMENT_HH
...
class Viosoftdebugelement : public Element { public:

	Viosoftdebugelement();
  ~Viosoftdebugelement();

  const char *class_name() const		{ return "Viosoftdebugelement"; }
